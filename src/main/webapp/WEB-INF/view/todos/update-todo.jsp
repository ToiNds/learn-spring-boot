    ...
    <section class="container">
        <form method="post">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="id" value="${todo.id}"/>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="localDate" value="${todo.date}"/>
                </div>
            </div>
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="done"
                               id="flexRadioDefault1" value="true" ${todo.done == true ? "checked" : ""}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="done"
                               id="flexRadioDefault2" value="false" ${todo.done == false ? "checked" : ""}
                        >
